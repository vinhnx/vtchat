...
/**
 * Optimized streaming text component that prevents layout shifts and jiggering
...
export const StreamingText = memo(({
    ...
    className,
    onAnimationComplete,
    speed = 80, // Default 80 characters per second
}: StreamingTextProps) => {
    ...
    return (
        <motion.span
            className={cn(
                "streaming-text transform-gpu will-change-contents",
                className
            )}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
