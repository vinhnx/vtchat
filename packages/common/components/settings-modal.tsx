...
export const SettingsModal = () => {
    ...
    return (
        <Dialog onOpenChange={() => setIsSettingsOpen(false)} open={isSettingsOpen}>
            <DialogContent className="mx-1 h-full max-h-[95vh] min-h-[500px] w-[calc(100vw-0.5rem)] !max-w-[1200px] overflow-x-hidden rounded-lg p-0 md:mx-auto md:max-h-[85vh] md:min-h-[700px] md:w-[95vw] md:rounded-xl lg:max-w-[1200px]">
