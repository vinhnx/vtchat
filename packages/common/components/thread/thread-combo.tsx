...
export function Thread() {
    ...
    const previousThreadItems = useChatStore(
        useShallow((state) => currentThreadId ? state.getPreviousThreadItems(currentThreadId) : []),
    );
    const currentThreadItem = useChatStore(
        useShallow((state) => currentThreadId ? state.getCurrentThreadItem(currentThreadId) : null),
    );
