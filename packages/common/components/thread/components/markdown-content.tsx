...
export const markdownStyles = {
    ...
    // Heading hierarchy with improved typography and consistent spacing
    'prose-h1:text-2xl prose-h1:font-bold prose-h1:border-b prose-h1:border-border prose-h1:pb-2 prose-h1:mb-6 prose-h1:mt-12':
        true,
    'prose-h2:text-xl prose-h2:font-semibold prose-h2:border-b prose-h2:border-border/60 prose-h2:pb-1 prose-h2:mb-5 prose-h2:mt-10':
        true,
    'prose-h3:text-lg prose-h3:font-medium prose-h3:mb-4 prose-h3:mt-9': true,
    'prose-h4:text-base prose-h4:font-medium prose-h4:opacity-90 prose-h4:mb-4 prose-h4:mt-8': true,
    ...
    'prose-blockquote:border-l-4 prose-blockquote:border-border prose-blockquote:pl-4 prose-blockquote:py-1 prose-blockquote:italic prose-blockquote:my-6 prose-blockquote:bg-secondary/20 prose-blockquote:rounded-r-md':
        true,

    // Code styling with improved readability
    'prose-code:font-mono prose-code:text-sm prose-code:font-normal prose-code:whitespace-nowrap':
        true,
    'prose-code:bg-secondary prose-code:border-border prose-code:border prose-code:rounded-md prose-code:px-1.5 prose-code:py-0.5':
        true,

    // Pre (code block) styling with improved visual design
    'prose-pre:bg-secondary prose-pre:border prose-pre:border-border prose-pre:rounded-lg prose-pre:p-4':
        true,

    // Table styling with improved structure and readability
    'prose-table:w-full prose-table:my-6 prose-table:border-collapse prose-table:bg-background':
        true,
    'prose-th:text-sm prose-th:font-semibold prose-th:bg-tertiary prose-th:px-4 prose-th:py-2.5 prose-th:border-b prose-th:border-r prose-th:last:border-r-0 prose-th:border-border prose-th:text-left':
        true,
    'prose-tr:border-b prose-tr:border-border': true,
    'prose-td:px-4 prose-td:py-3 prose-td:border-b prose-td:border-r prose-td:last:border-r-0 prose-td:border-border prose-td:align-top':
        true,

    // Link styling with improved accessibility
    'prose-a:text-brand prose-a:underline prose-a:underline-offset-2 prose-a:decoration-[0.08em] hover:prose-a:no-underline prose-a:font-medium':
        true,
    ...
    'prose-img:rounded-md prose-img:my-6 prose-img:max-w-full prose-img:shadow-sm prose-img:mx-auto':
        true,
