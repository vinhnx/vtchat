...
export const ThemeSwitcher = ({
    ...
    if (!mounted) {
        return (
            <div className={`relative isolate flex h-8 rounded-full bg-gray-100 dark:bg-gray-800 p-1 ring-1 ring-gray-200 dark:ring-gray-700 ${className}`}>
        ...
        >
            {themes.map(({ key, icon: Icon, label }) => {
                ...
                return (
                    ...
                    >
                        {isActive && (
                            <div className="absolute inset-0 rounded-full bg-secondary transition-all duration-200" />
                        )}
                        <Icon
                        ...
                        {showSystemHint && (
                            <SystemHintIcon
                                className="absolute -bottom-0.5 -right-0.5 h-2 w-2 text-muted-foreground"
                                strokeWidth={3}
                            />
                        )}
                    </button>
