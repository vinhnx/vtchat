...
/**
 * Creem Credits Purchase Component
 *
 * Allows users to purchase credits using Creem.io
...
interface CreditPackageCardProps {
    packageData: ReturnType<typeof CreemService.getCreditPackages>[0];
    onPurchase: (packageId: keyof typeof CREEM_CREDIT_PACKAGES) => void;
    isLoading?: boolean;
}
...
interface SubscriptionPlanCardProps {
    planData: ReturnType<typeof CreemService.getSubscriptionPlans>[0];
    onSubscribe: () => void;
    isLoading?: boolean;
}
...
export function CreemCreditsShop() {
...
export default CreemCreditsShop;
