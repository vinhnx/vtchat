...
- **All Premium AI Models**: Access to Claude 4, GPT-4.1, O3, Gemini 3 Pro, DeepSeek R1, Grok 3 with your own API keys (BYOK)
- **Gemini Access**: Gemini 3 Flash Lite now requires your own Gemini API key (BYOK). VT+ members receive managed access to higher tier Gemini models (Flash, Pro) and OpenRouter community models without exposing their keys to VT servers.
...
- **Expanded Gemini Access**: VT+ subscribers receive expanded, managed access to Gemini 3 Flash and Pro tiers, while Gemini 3 Flash Lite continues to operate through each member's BYOK configuration for full transparency over usage.
