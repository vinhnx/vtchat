...
describe('Tool Registry', () => {
    ...
    test('should have proper tool structure', () => {
        for (const tool of TOOL_REGISTRY) {
            ...
            expect(['FREE', 'PLUS']).toContain(tool.tier);
    ...
    describe('getAvailableTools', () => {
        test('should return only FREE tools for free tier', () => {
            ...
            expect(tools.every((tool) => tool.tier === 'FREE')).toBe(true);
        ...
        test('should return all tools for PLUS tier', () => {
            const tools = getAvailableTools('PLUS');
    ...
    describe('hasToolAccess', () => {
        ...
        test('should allow all tools for PLUS users', () => {
            expect(hasToolAccess('web-search', 'PLUS')).toBe(true);
            expect(hasToolAccess('calculator', 'PLUS')).toBe(true);
            expect(hasToolAccess('charts', 'PLUS')).toBe(true);
        });

        test('should return false for nonexistent tools', () => {
            expect(hasToolAccess('nonexistent', 'FREE')).toBe(false);
            expect(hasToolAccess('nonexistent', 'PLUS')).toBe(false);
        });
