...
export class ErrorMessageService {
    ...
    static getInvalidApiKeyError(context: ErrorContext): ErrorMessage {
        ...
        return {
            ...
            message: `The ${providerName} API key format is incorrect. ${
                getFormatGuidance(provider)
            }.`,
            action:
    ...
    static getRateLimitError(context: ErrorContext): ErrorMessage {
        ...
        return {
            ...
            message:
                `You've exceeded the rate limit for ${providerName}. This is typically temporary and will reset shortly.`,
    ...
    static getNetworkError(context: ErrorContext): ErrorMessage {
        ...
        if (originalError?.includes('timeout') || originalError?.includes('ETIMEDOUT')) {
            return {
                ...
                message:
                    `The request to ${providerName} timed out. This might be due to network issues or high server load.`,
    ...
    static getServiceUnavailableError(context: ErrorContext): ErrorMessage {
        ...
        if (originalError?.includes('model not found')) {
            return {
                ...
                message:
                    `The requested model is not available on ${providerName}. It may have been deprecated or renamed.`,
        ...
        if (
            ...
            return {
                ...
                message:
                    `${providerName} is experiencing technical difficulties. This is usually temporary.`,
        ...
        return {
            ...
            message:
                `${providerName} is currently unavailable. This might be due to maintenance or high demand.`,
