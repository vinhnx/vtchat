 ...
 */
export var openSandbox = function () {
    return tool({
        description: "Create and run code in a lightweight client-side sandbox. Available to all users for simple code execution.",
        parameters: z.object({
            files: z
        ...
        execute: function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
            var files = _b.files, language = _b.language;
