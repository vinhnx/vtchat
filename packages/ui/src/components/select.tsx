...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        className={cn(
            'rounded-xs outline-hidden focus:bg-accent focus:text-accent-foreground relative flex w-full cursor-default select-none items-center py-1.5 pl-8 pr-2 text-sm data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
            className,
        )}
        ref={ref}
        {...props}
