...
export const REACT_SCAN_CONFIG = {
    ...
    enabled: process.env.NODE_ENV === 'development' && !process.env.VERCEL
    ...
    showToolbar: process.env.NODE_ENV === 'development' && !process.env.VERCEL
        && !process.env.FLY_APP_NAME,
    ...
    trackUnnecessaryRenders: process.env.NODE_ENV === 'development' && !process.env.VERCEL
        && !process.env.FLY_APP_NAME,
    ...
    shouldRun: process.env.REACT_SCAN_ENABLED === 'true'
        && process.env.NODE_ENV === 'development'
        && !process.env.VERCEL
        && !process.env.FLY_APP_NAME
        && !process.env.NETLIFY
