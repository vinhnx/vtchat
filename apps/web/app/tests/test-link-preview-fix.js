...
const mdxComponentsPath = path.join(__dirname, '../../../../packages/common/components/mdx/mdx-components.tsx');
...
const citationProviderPath = path.join(__dirname, '../../../../packages/common/components/thread/citation-provider.tsx');
...
const linkPreviewPath = path.join(__dirname, '../../../../packages/common/components/link-preview.tsx');
