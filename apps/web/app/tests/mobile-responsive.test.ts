...
test.describe('Mobile Responsive Design', () => {
    ...
    test('Mobile layout - core functionality works', async ({ page }) => {
        ...
        await expect(page.locator('[data-testid="mobile-header"]').or(page.locator('.md\\:hidden').first())).toBeVisible();
    ...
    test('Mobile settings modal is responsive', async ({ page }) => {
        ...
        const userButton = page.locator('button').filter({ hasText: /user|profile|settings/i }).first();
        ...
        if (await floatingButton.isVisible()) {
            ...
            const settingsMenuItem = page.locator('[role="menuitem"]').filter({ hasText: /settings/i });
    ...
    test('Tablet layout works correctly', async ({ page }) => {
        ...
        const sidebar = page.locator('.hidden.md\\:flex').or(page.locator('[data-testid="sidebar"]'));
    ...
    test('Mobile navigation accessibility', async ({ page }) => {
        ...
        const mobileNavButton = page.locator('button[aria-label*="menu"], button[aria-label*="navigation"]').first();
