...
describe('X.AI Credit Error Toast', () => {
    test('should identify X.AI credit error messages correctly', () => {
        const testCases = [
            {
                error:
                    "Your newly created teams doesn't have any credits yet. You can purchase credits on https://console.x.ai/team/89688622-78c1-4759-93df-c41e1c95c3cd.",
                expectedTitle: '💳 X.AI Credits Required',
            },
            {
                error:
                    "💳 X.AI Credits Required: Your newly created teams doesn't have any credits yet.",
                expectedTitle: '💳 X.AI Credits Required',
            },
            {
                error:
                    "Error: Error: Your newly created teams doesn't have any credits yet. You can purchase credits on https://console.x.ai/team/...",
                expectedTitle: '💳 X.AI Credits Required',
            },
            {
