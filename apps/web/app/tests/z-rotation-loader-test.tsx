        ...
        <div className="min-h-screen bg-background p-8 space-y-8">
            <div className="max-w-2xl mx-auto space-y-8">
                ...
                <div className="text-center text-sm text-muted-foreground">
                    <p>This loader combines translateZ (depth movement) with rotateY (horizontal rotation).</p>
                    <p>The animation creates a 3D effect with the cube moving in and out while rotating.</p>
                </div>
            </div>
        </div>
    );
