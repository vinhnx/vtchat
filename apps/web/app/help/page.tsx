                    ...
                    <Accordion className='w-full space-y-4' collapsible type='single'>
                        ...
                        <AccordionItem value='thread-isolation'>
                            ...
                            <AccordionContent>
                                <p className='text-muted-foreground'>
                                    This is a{' '}
                                    <strong>security feature</strong>, not a bug! VT implements
                                    per-account thread isolation to protect your privacy.
                                </p>
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    <li className='text-muted-foreground'>
                                        <strong>Anonymous users</strong>{' '}
                                        have their own separate thread database
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Each logged-in user</strong>{' '}
                                        gets their own isolated thread storage
                                    </li>
                                    <li className='text-muted-foreground'>
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    <li className='text-muted-foreground'>
                                        ...
                                        OpenAI, Anthropic, Google, Fireworks, Together AI, and xAI
                                    </li>
                                    <li className='text-muted-foreground'>
                                    ...
                                    <li className='text-muted-foreground'>
                                        ...
                                        Upload and analyze PDFs, documents, and images with AI
                                        models (Free for all users)
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Structured Output:</strong>{' '}
                                        Extract structured data from documents (Free for all users -
                                        Gemini models only)
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Chart Visualization:</strong>{' '}
                                        Create interactive bar charts, line graphs, pie charts, and
                                        scatter plots (Free for all users)
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Intelligent Tool Router:</strong>{' '}
                                        AI-powered semantic routing automatically activates tools
                                        based on your queries (Free for all users)
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Math Calculator:</strong>{' '}
                                        Advanced mathematical computations and problem solving
                                    </li>
                                    <li className='text-muted-foreground'>
                                    ...
                                    <li className='text-muted-foreground'>
                                        <strong>Multiple Chat Modes:</strong>{' '}
                                        Specialized modes for different use cases
                                    </li>
                                </ul>
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value='advanced-features'>
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-2 list-outside list-disc space-y-2 pl-4'>
                                    <li className='text-muted-foreground'>
                                        <strong>Advanced UI:</strong>{' '}
                                        Dark mode, thinking mode toggle, structured output
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Document & Image Processing:</strong>{' '}
                                        Upload PDFs, images, analyze documents with structured data
                                        extraction
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>AI Capabilities:</strong>{' '}
                                        Intelligent tool routing, reasoning chain, thinking mode,
                                        Gemini caching, chart visualization, web search
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>All Chat Tools:</strong>{' '}
                                        Mathematical computing, multi-modal processing, productivity
                                        tools
                                    </li>
                                </ul>
                                <h4 className='text-foreground mb-2 mt-4 font-medium'>
                        ...
                        <AccordionItem value='structured-output'>
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    <li className='text-muted-foreground'>
                                        <strong>Gemini Models Only:</strong>{' '}
                                        Currently available only with Google Gemini models for
                                        optimal accuracy
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Document Types:</strong>{' '}
                                        Automatically detects and extracts data from invoices,
                                        resumes, contracts, and general documents
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Smart Schema:</strong>{' '}
                                        Uses intelligent schemas to extract relevant fields like
                                        contact info, dates, amounts, and terms
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Export Options:</strong>{' '}
                                        Download extracted data as JSON or view in structured format
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>PDF Support:</strong>{' '}
                                        Currently supports PDF files with plans to expand to other
                                        document formats
                                    </li>
                                </ul>
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    ...
                                    <li className='text-muted-foreground'>
                                        ...
                                        All quotas reset at 00:00 UTC each day
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Database-Driven:</strong>{' '}
                                        Quotas are managed through a flexible database system that
                                        allows for dynamic adjustments
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Real-Time Tracking:</strong>{' '}
                                        Your usage is tracked in real-time and displayed in your
                                        settings
                                    </li>
                                </ul>
                                <p className='text-muted-foreground mt-4 text-sm'>
                        ...
                        <AccordionItem value='thinking-mode'>
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    <li className='text-muted-foreground'>
                                        <strong>Gemini Models Only:</strong>{' '}
                                        Currently available only with Google Gemini models that
                                        support reasoning
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Free Feature:</strong>{' '}
                                        Available to all registered users with adjustable thinking
                                        budget in settings
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Reasoning Display:</strong>{' '}
                                        See the AI's step-by-step thought process before the final
                                        answer
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Thoughtful Responses:</strong>{' '}
                                        More deliberate and well-reasoned answers for complex
                                        questions
                                    </li>
                                    <li className='text-muted-foreground'>
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    ...
                                    <li className='text-muted-foreground'>
                                        ...
                                        Significantly reduces API costs when you have long
                                        conversations or reuse similar context
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Configurable Duration:</strong>{' '}
                                        Cache conversations for 1 minute to 1 hour based on your
                                        needs
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Cache Management:</strong>{' '}
                                        Manage up to 20 cached conversations simultaneously
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Automatic Cleanup:</strong>{' '}
                                        Cached content expires automatically based on your TTL
                                        settings
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Smart Context Reuse:</strong>{' '}
                                        Reuses conversation context intelligently without
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    ...
                                    <li className='text-muted-foreground'>
                                        ...
                                        For unrestricted usage, you can always use your own API key.
                                    </li>
                                </ul>
                                <p className='text-muted-foreground mt-4 text-sm'>
                        ...
                        <AccordionItem value='vt-plus-gemini-models'>
                            ...
                            <AccordionContent>
                                <p className='text-muted-foreground'>
                                    <strong>VT+ Required:</strong>{' '}
                                    Server-funded access to Gemini models now requires VT+
                                    subscription. VT+ users get access to all Gemini models without
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    ...
                                    <li className='text-muted-foreground'>
                                        ...
                                        Web search, math calculator, and chart visualization work
                                        seamlessly with all Gemini models
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>No API Key Required:</strong>{' '}
                                        System automatically handles API key management for VT+
                                        users
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Premium Features:</strong>{' '}
                                        Thinking mode, structured output, and document processing
                                        available with all Gemini models
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Budget Protection:</strong>{' '}
                                        Usage is monitored with monthly budget caps to ensure
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    <li className='text-muted-foreground'>
                                        ...
                                        R1, and Grok 3. You also get access to a wide range of
                                        advanced features like the intelligent tool router, chart
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    <li className='text-muted-foreground'>
                                        ...
                                        Custom orchestration for coordinating complex tasks
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Task Planning:</strong>{' '}
                                        Intelligent task breakdown and execution
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Research Agents:</strong>{' '}
                                        Multi-step research with information gathering and analysis
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Reflective Analysis:</strong>{' '}
                                        Self-improvement through prior reasoning analysis
                                    </li>
                                </ul>
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value='chart-visualization'>
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    <li className='text-muted-foreground'>
                                        <strong>Free Feature:</strong>{' '}
                                        Available to all users with AI-powered chart generation and
                                        intelligent routing
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Chart Types:</strong>{' '}
                                        Bar charts, line charts, area charts, pie charts, and radar
                                        charts
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Interactive Features:</strong>{' '}
                                        Hover effects, tooltips, animations, and responsive design
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Easy Creation:</strong>{' '}
                                        Simply ask the AI to create charts with your data or
                                        specifications
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Automatic Activation:</strong>{' '}
                                        The intelligent router detects chart requests and activates
                                        visualization mode automatically
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Professional Design:</strong>{' '}
                                        Beautiful visualizations with shadcn/ui styling and
                                        animations
                                    </li>
                                </ul>
                                <p className='text-muted-foreground mt-4 text-sm'>
                        ...
                        <AccordionItem value='multi-modal-chat'>
                            ...
                            <AccordionContent>
                                ...
                                <ul className='mt-4 list-outside list-disc space-y-2 pl-4'>
                                    <li className='text-muted-foreground'>
                                        <strong>Free Feature:</strong>{' '}
                                        Available to all registered users with supported AI models
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Supported Models:</strong>{' '}
                                        GPT-4o, Claude models, Gemini models, and other
                                        vision-capable models
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Image Support:</strong>{' '}
                                        JPEG, PNG, GIF, and WebP images up to 10MB each
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>PDF Support:</strong>{' '}
                                        Full PDF document analysis and text extraction
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Multiple Files:</strong>{' '}
                                        Upload up to 5 files per conversation
                                    </li>
                                    <li className='text-muted-foreground'>
                                        <strong>Smart Model Selection:</strong>{' '}
                                        Multi-modal upload appears only when supported models are
                                        selected
                                    </li>
                                </ul>
                                <p className='text-muted-foreground mt-4 text-sm'>
