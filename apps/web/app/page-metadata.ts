...
export const defaultMetadata: Metadata = {
    ...
    title: {
        default: "VT - Minimal AI Chat with Deep Research Features",
        template: "%s | VT",
    },
    description:
    ...
    openGraph: {
        ...
        url: baseUrl,
        siteName: "VT",
        title: "VT - Minimal AI Chat with Deep Research Features",
        description:
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "VT - Minimal AI Chat with Deep Research Features",
                type: "image/jpeg",
            },
        ],
    },
