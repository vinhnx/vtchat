    ...
    try {
        ...
        if (response.ok) {
            ...
            if (reader) {
                ...
                while (eventCount < 10) { // Read first 10 events
                    ...
                    for (const line of lines) {
                        if (line.startsWith('event: ') || line.startsWith('data: ')) {
                            ...
                            if (line.includes('web-search') || line.includes('search')) hasWebSearch = true;
                        }
                    }
                }
            ...
            if (errorText.includes("API key")) {
                ...
                console.log("⚠️  Rate limit error - this means the system is working but limits are reached");
                return true;
            } else {
