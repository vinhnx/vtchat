...
- Implemented conversational continuity for image generation/editing with Gemini 3 Flash Image.
...
- Continues to use `ModelEnum.GEMINI_3_FLASH_IMAGE` under the hood.
