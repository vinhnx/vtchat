...
- **VT+ ($10/month)**: Everything free + professional features: PRO_SEARCH (Enhanced Web Search - 50/day), DEEP_RESEARCH (Deep Research capabilities - 25/day), advanced document processing (25MB files), priority AI access, custom workflows, premium exports, extended chat history, and priority support
